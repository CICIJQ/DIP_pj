...
from data.transforms import Sobel, to_norm_tensor, to_tensor, ReflectionSythesis_1, ReflectionSythesis_2, RealisticReflectionSynthesis
...
class RealisticCEILDataset(CEILDataset):
    def __init__(
            self,
            datadir,
            fns=None,
            ...
            noise_std=0.01,
            jpeg_prob=0.25):
        super(RealisticCEILDataset, self).__init__(
            datadir,
            fns=fns,
            size=size,
        ...
        self.syn_model = RealisticReflectionSynthesis(
            low_sigma=low_sigma,
            high_sigma=high_sigma,
            alpha_min=alpha_min,
            alpha_max=alpha_max,
