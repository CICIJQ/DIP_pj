        ...
        for i, data in enumerate(train_loader):
            ...
            if not opt.no_log:
                ...
                if iterations % opt.print_freq == 0:
                    ...
                    self.visualizer.print_current_errors(epoch, iterations, errors, t)
            ...
            for i, data in enumerate(val_loader):                
                ...
                if index:
                    ...
                    if isinstance(data_name, (list, tuple)):
                        image_name = data_name[0]
                    else:
                        image_name = data_name
                    if image_name is None:
                        image_name = str(i)
                    metric_row = {'image': os.path.splitext(os.path.basename(image_name))[0]}
                    metric_row.update(index)
